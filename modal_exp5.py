"""Modal launcher for EXP-005 (synthetic prior-free landscape).
...
APP_NAME = os.environ.get("MODAL_APP_NAME", "exp5-synthetic-landscape")
...
def main(phase: str = "all", models: str = "7B,1.5B",
    ...
    print(f"== EXP-005 on Modal :: phase={phase} :: {len(tasks)} GPU({GPU}) task(s) "
