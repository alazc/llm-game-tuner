...
# salary/jail/card handling use dynamic board length + landmark indices so boards
# shorter than 40 cells play correctly; added _should_buy / _improve_cash_floor hooks.
""" Player Class
"""
